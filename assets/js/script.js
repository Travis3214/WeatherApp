...
// Function to diplay the 5 day forecast from fetch request {needs icon, temp, humidity, date, wind speed}
// Create elements for each of the above
// Function to display 5 day forecast data from fetch request each card
